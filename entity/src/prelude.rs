...
pub use super::base::downvote::ActiveModel as DownvoteActiveModel;
...
pub use super::base::upvote::ActiveModel as UpvoteActiveModel;
pub use super::base::user::ActiveModel as UserActiveModel;

pub use super::base::downvote::Model as DownvoteModel;
...
pub use super::base::upvote::Model as UpvoteModel;
pub use super::base::user::Model as UserModel;

pub use super::base::downvote::Column as DownvoteColumn;
...
pub use super::base::upvote::Column as UpvoteColumn;
